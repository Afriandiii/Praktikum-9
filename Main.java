public class Main {
    ...
    public static void main(String[] args){
        ...
        Buku buku1 = new Buku("B001", "Pemrograma Web");
        Buku buku2 = new Buku ("B002", "Basis Data");
        BukuLuar buku3 = new BukuLuar("B003", "Algoritma");

        Petugas petugas1 = new Petugas("Afri", "P001");
        Peminjam peminjam1 = new Mahasiswa();
        peminjam1.setNamaPeminjam("Andi");
        peminjam1.setKodePeminjam("M001");

        Peminjam peminjam2 = new Mahasiswa();
        peminjam2.setNamaPeminjam("Aulia");
